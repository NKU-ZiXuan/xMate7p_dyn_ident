...
class TrajPlotter:
    ...
    def plot_desired_traj(self, fourier_x, folder):
        ...
        # plt_dq.legend()
        plt_dq.set_ylabel(r'$\dot{q}$ (rad/s)')
        ...
        plt_ddq.set_ylabel(r'$\ddot{q}$ (rad/s$^2$)')
        #plt.tight_layout()
        plt.savefig(folder+'excited trajectory.png', dpi=750, bbox_inches='tight')
        plt.show()
