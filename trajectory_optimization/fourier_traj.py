...
class FourierTraj:
    def __init__(self, dof, order, base_freq, sample_num_per_period=10, frequency='nan', final_time=20):
        self.dof = dof
        self.order = order
    ...
    def _gen_q_base(self):
        ...
        for n in range(self.sample_num):
            ...
            for o in range(self.order):
                phase = 2 * np.pi * self.base_freq * (o + 1) * self.t[n]

                c = 2 * np.pi * self.base_freq * (o + 1)
